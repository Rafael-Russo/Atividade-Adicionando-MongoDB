...
public class FipeService {
    ...
    public MarcaEntity marcaPorId(String id){
        return marcaRepository.findById(id).orElse(null);
    }
    public MarcaEntity inserirMarca(MarcaEntity marca){
        return marcaRepository.save(marca);
    }
    public MarcaEntity atualizaMarca(String id, MarcaEntity marca){
        MarcaEntity existingMarca = marcaRepository.findById(id).orElse(null);
    ...
    public void deletaMarca(String id){
